...
# contextlib - python module which provides utilities for common tasks involving the with statement.
# It closes the connection automatically, no need of explicit close statement.
